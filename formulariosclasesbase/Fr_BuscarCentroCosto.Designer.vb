...
Partial Class Fr_BuscarCentroCosto
  ...
  Private Sub InitializeComponent()
        ...
        Me.ComboBox_Filtrar.Items.AddRange(New Object() {"CODIGO", "NOMBRE"})
  ...
  Friend WithEvents Dgv_Buscar As Windows.Forms.DataGridView
  Friend WithEvents Panel1 As Windows.Forms.Panel
  Friend WithEvents GroupBox1 As Windows.Forms.GroupBox
  Friend WithEvents Cb_Filtrar As Windows.Forms.CheckBox
  Friend WithEvents Tb_Descripción As Windows.Forms.TextBox
  Friend WithEvents ComboBox_Filtrar As Windows.Forms.ComboBox
End Class
