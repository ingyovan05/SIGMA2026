...
Public Class Cl_ColumnaHora
    ...
    Public Overrides Property CellTemplate As DataGridViewCell
        ...
        Set(value As DataGridViewCell)
            If value IsNot Nothing AndAlso Not value.GetType.IsAssignableFrom(GetType(TimeCell)) Then
                Throw New InvalidCastException("Debe ser una celda hora")
            End If
