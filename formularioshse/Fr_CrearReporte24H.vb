...
Public Class Fr_CrearReporte24H
    ...
    Public Sub ComportamientoPredeterminado()
        ...
        Me.Cb_Contrato.SelectedIndex = -1
        ...
        Me.Cu_BuscarPersonaDirectorObra.Cb_Persona.SelectedIndex = -1
        Me.Cu_BuscarPersonaCoordinadorHSE.Cb_Persona.SelectedIndex = -1
        Me.Cu_BuscarPersonaResponsableActividad.Cb_Persona.SelectedIndex = -1
        Me.Cu_BuscarPersonaMedicoEnfermero.Cb_Persona.SelectedIndex = -1
        ...
        Me.Cu_CiudadPersonaAfectada.Cb_Ciudad.SelectedIndex = -1
    ...
    Public Sub CargarTablas()
        ...
        Cb_Contrato.DataSource = dsCargar.Tables(32)
        ...
        Me.Cu_BuscarPersonaCoordinadorHSE.CargarDatos()
        Me.Cu_BuscarPersonaAfectada.CargarDatos()
        Me.Cu_BuscarPersonaResponsableActividad.CargarDatos()
        Me.Cu_BuscarPersonaMedicoEnfermero.CargarDatos()
        Me.Cu_BuscarPersonaDirectorObra.CargarDatos()
        Me.Cu_CiudadIncidente.CargarDatos()
        Me.Cu_CiudadPersonaAfectada.CargarDatos()
    ...
    Public Sub LlenarReporte()
        If TIPO = 2 Then
            ...
            Else
                ...
                Else
                    If Recurrencia = "3" Then
                        Me.Cb_Recurrencia.SelectedValue = 3
                    Else
                        Me.Cb_Recurrencia.SelectedValue = 4
                    End If
                End If
            End If
            ...
            Me.Tb_AccionInmediata1.Text = filareporte("ACCIONESINMEDIATAS_1").ToString
            Me.Tb_AccionInmediata2.Text = filareporte("ACCIONESINMEDIATAS_2").ToString
            Me.Tb_AccionInmediata3.Text = filareporte("ACCIONESINMEDIATAS_3").ToString
            ...
            Me.Cu_BuscarPersonaDirectorObra.Cb_Persona.SelectedValue = filareporte("IDDIRECTOROBRA")
            Me.Cu_BuscarPersonaCoordinadorHSE.Cb_Persona.SelectedValue = filareporte("IDCOORDINADORHSE")
            Me.Cu_BuscarPersonaResponsableActividad.Cb_Persona.SelectedValue = filareporte("IDRESPONSABLEACTIVIDAD")
            Me.Cu_BuscarPersonaMedicoEnfermero.Cb_Persona.SelectedValue = filareporte("IDMEDICOENFERMERO")
            ...
            If filareporte("IDTIPOINCIDENTE").ToString = "1" Then
                ...
                Me.Cu_CiudadPersonaAfectada.Cb_Ciudad.SelectedValue = filareportepersona("CIUDADPERSONAAFECTADA")
                ...
                If filareportepersona("TIPOACCIDENTE") = "V" Then
                    Me.Rb_Violencia.Checked = True
                ElseIf filareportepersona("TIPOACCIDENTE") = "T" Then
                    Me.Rb_Transito.Checked = True
                ElseIf filareportepersona("TIPOACCIDENTE") = "D" Then
                    Me.Rb_Deportivo.Checked = True
                ElseIf filareportepersona("TIPOACCIDENTE") = "R" Then
                    Me.Rb_Recreativo.Checked = True
                ElseIf filareportepersona("TIPOACCIDENTE") = "P" Then
                    Me.Rb_PropioTrabajo.Checked = True
                End If
    ...
    Private Sub Dgv_Testigos_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Dgv_Testigos.KeyDown
        Select Case e.KeyCode
            Case Keys.F3
                ...
                EliminarFilasVaciasTestigos()
        End Select

    End Sub

    Private Sub EliminarFilasVaciasTestigos()
        Try
            ...
            Case Dgv_Testigos.Columns("Cedula").Index
                ...
                For i = 0 To Dgv_Testigos.Rows.Count - 2
                    If Dgv_Testigos.Item(e.ColumnIndex, i).Value.ToString = "" Then
                        MsgBox("Hay campos de la columna cedula sin llenar anteriores o posteriores a la fila actual")
    ...
    Public Function ValidarCasillas() As Boolean
        ...
        If DTP_FechaIncidente.Checked = False Then
            ...
            Exit Function
        End If
        If DTP_HoraIncidente.Checked = False Then
            MsgBox("Debe seleccionar la hora del incidente.", MsgBoxStyle.Information, "Hora del incidente")
            TabControl1.SelectedIndex = 0
            ValidarCasillas = False
            DTP_HoraIncidente.Focus()
            Exit Function
        End If
        If DTP_FechaIncidente.Value.Day = Today.Day Then
            ...
            End If
        End If
        If DTP_HorasLaboradas.Checked = False Then
            MsgBox("Debe seleccionar las horas laboradas.", MsgBoxStyle.Information, "Horas laboradas")
            TabControl1.SelectedIndex = 0
            ValidarCasillas = False
        ...
        End If
        If DTP_HorasLaboradas.Value.Hour = 10 Then
            If DTP_HorasLaboradas.Value.Minute > 0 Then
                MsgBox("No puede seleccionar mas de 10 horas", MsgBoxStyle.Information, "Horas laboradas")
                ValidarCasillas = False
                TabControl1.SelectedIndex = 0
                DTP_HorasLaboradas.Focus()
        ...
        If Cu_BuscarPersonaDirectorObra.Cb_Persona.Text = "" OrElse Cu_BuscarPersonaDirectorObra.Cb_Persona.SelectedIndex = -1 Then
            MsgBox("Debe seleccionar el director de obra.", MsgBoxStyle.Information, "Validado por")
            TabControl1.SelectedIndex = 0
            Cu_BuscarPersonaDirectorObra.Cb_Persona.Focus()
            ValidarCasillas = False
            Exit Function
        End If
        If Cu_BuscarPersonaCoordinadorHSE.Cb_Persona.Text = "" OrElse Cu_BuscarPersonaCoordinadorHSE.Cb_Persona.SelectedIndex = -1 Then
            MsgBox("Debe seleccionar el coordinador HSE.", MsgBoxStyle.Information, "Validado por")
            TabControl1.SelectedIndex = 0
            Cu_BuscarPersonaCoordinadorHSE.Cb_Persona.Focus()
            ValidarCasillas = False
            Exit Function
        End If
        If Cu_BuscarPersonaResponsableActividad.Cb_Persona.Text = "" OrElse Cu_BuscarPersonaResponsableActividad.Cb_Persona.SelectedIndex = -1 Then
            MsgBox("Debe seleccionar el responsable de la actividad.", MsgBoxStyle.Information, "Validado por")
            TabControl1.SelectedIndex = 0
            Cu_BuscarPersonaCoordinadorHSE.Cb_Persona.Focus()
            ValidarCasillas = False
            Exit Function
        ...
        If Cb_TipoIncidente.SelectedValue = 1 Then
            ...
            '    Exit Function
            'End If
            If Cu_CiudadPersonaAfectada.Cb_Ciudad.Text = "" OrElse Cu_CiudadPersonaAfectada.Cb_Ciudad.SelectedIndex = -1 Then
                MsgBox("Debe seleccionar la ciudad del incidente.", MsgBoxStyle.Information, "Ciudad del incidente")
                TabControl1.SelectedIndex = 1
                Cu_CiudadPersonaAfectada.Cb_Ciudad.Focus()
                ValidarCasillas = False
                Exit Function
            End If
            If Tb_CorreoElectronico.Text <> "" Then
                If Not FuncionesBase.FuncionesBase.validarDireccionCorreo(Tb_CorreoElectronico.Text) Then
            ...
            If DTP_InicioContrato.Checked = False Then
                ...
                Exit Function
            End If
            If Rb_Violencia.Checked = False AndAlso Rb_Transito.Checked = False AndAlso Rb_Deportivo.Checked = False AndAlso Rb_Recreativo.Checked = False AndAlso Rb_PropioTrabajo.Checked = False Then
                MsgBox("Debe seleccionar el tipo de accidente.", MsgBoxStyle.Information, "Tipo De Accidente")
                TabControl1.SelectedIndex = 1
                ValidarCasillas = False
                Exit Function
            End If
            ...
            If Rb_TestigosSi.Checked Then
                ...
                For i As Integer = 0 To dtTestigos.Rows.Count - 1
                    For j As Integer = 0 To dtTestigos.Columns.Count - 1
                        If dtTestigos.Rows(i).Item(j) Is Nothing Or dtTestigos.Rows(i).Item(j).ToString = "" Then
                            MsgBox("Debe ingresar todos los datos de los testigos.", MsgBoxStyle.Information, "Testigos")
                            TabControl1.SelectedIndex = 2
                            ValidarCasillas = False
                            Exit Function
                        End If
    ...
    Public Function GuardarReporte24H() As Boolean
        If ValidarCasillas() = False Then
            GuardarReporte24H = False
            Exit Function
        End If
        ...
        Comando.Parameters.AddWithValue("@CONTRATO", Me.Cb_Contrato.SelectedValue)
        ...
        Comando.Parameters.AddWithValue("@ACCIONESINMEDIATAS_1", Me.Tb_AccionInmediata1.Text)
        Comando.Parameters.AddWithValue("@ACCIONESINMEDIATAS_2", Me.Tb_AccionInmediata2.Text)
        Comando.Parameters.AddWithValue("@ACCIONESINMEDIATAS_3", Me.Tb_AccionInmediata3.Text)
        ...
        Comando.Parameters.AddWithValue("@IDDIRECTOROBRA", Me.Cu_BuscarPersonaDirectorObra.Cb_Persona.SelectedValue)
        Comando.Parameters.AddWithValue("@IDCOORDINADORHSE", Me.Cu_BuscarPersonaCoordinadorHSE.Cb_Persona.SelectedValue)
        Comando.Parameters.AddWithValue("@IDRESPONSABLEACTIVIDAD", Me.Cu_BuscarPersonaResponsableActividad.Cb_Persona.SelectedValue)
        Comando.Parameters.AddWithValue("@IDMEDICOENFERMERO", Me.Cu_BuscarPersonaMedicoEnfermero.Cb_Persona.SelectedValue)
        ...
        If Cb_TipoIncidente.SelectedValue.ToString() = "1" Then
            ...
            Comando.Parameters.AddWithValue("@CIUDADPERSONAAFECTADA", Me.Cu_CiudadPersonaAfectada.Tx_Codigo.Text)
            ...
            If Rb_Violencia.Checked Then
                Comando.Parameters.AddWithValue("@TIPOACCIDENTE", "V")
            End If
            If Rb_Transito.Checked Then
                Comando.Parameters.AddWithValue("@TIPOACCIDENTE", "T")
            End If
            If Rb_Deportivo.Checked Then
                Comando.Parameters.AddWithValue("@TIPOACCIDENTE", "D")
            End If
            If Rb_Recreativo.Checked Then
                Comando.Parameters.AddWithValue("@TIPOACCIDENTE", "R")
            End If
            If Rb_PropioTrabajo.Checked Then
                Comando.Parameters.AddWithValue("@TIPOACCIDENTE", "P")
            End If
            ...
            If Me.Rb_TestigosSi.Checked Then
                Comando.Parameters.AddWithValue("@TestigoSiNo", "S")
                Dim Fila As DataRow
                For i = 0 To Dgv_Testigos.Rows.Count - 2
                    Dim IdPersona
                ...
                Next
            Else
                Comando.Parameters.AddWithValue("@TestigoSiNo", "N")
            End If
    ...
    Private Sub Bt_Guardar_Click(sender As Object, e As EventArgs) Handles Bt_Guardar.Click
        If GuardarReporte24H() = True Then
            Me.Close()
        End If
    End Sub
...
Private Sub CalcularPerdida()
    ...
    Public Sub cargarpersonalasociadobodega(Optional ByVal IDPERSONA As Integer = -1,
        ...
        End Try
        Try
            temp = Me.Cu_BuscarPersonaDirectorObra.Cb_Persona.SelectedValue
            Me.Cu_BuscarPersonaDirectorObra.CargarDatos()
            Me.Cu_BuscarPersonaDirectorObra.Cb_Persona.SelectedValue = temp
            Me.Cu_BuscarPersonaDirectorObra.CargarCajaTexto()
        Catch ex As Exception
        End Try
        Try
            temp = Me.Cu_BuscarPersonaCoordinadorHSE.Cb_Persona.SelectedValue
            Me.Cu_BuscarPersonaCoordinadorHSE.CargarDatos()
            Me.Cu_BuscarPersonaCoordinadorHSE.Cb_Persona.SelectedValue = temp
            Me.Cu_BuscarPersonaCoordinadorHSE.CargarCajaTexto()
        Catch ex As Exception
        End Try
        Try
            temp = Me.Cu_BuscarPersonaResponsableActividad.Cb_Persona.SelectedValue
            Me.Cu_BuscarPersonaResponsableActividad.CargarDatos()
            Me.Cu_BuscarPersonaResponsableActividad.Cb_Persona.SelectedValue = temp
            Me.Cu_BuscarPersonaResponsableActividad.CargarCajaTexto()
        Catch ex As Exception
        End Try
        Try
            temp = Me.Cu_BuscarPersonaMedicoEnfermero.Cb_Persona.SelectedValue
            Me.Cu_BuscarPersonaMedicoEnfermero.CargarDatos()
            Me.Cu_BuscarPersonaMedicoEnfermero.Cb_Persona.SelectedValue = temp
            Me.Cu_BuscarPersonaMedicoEnfermero.CargarCajaTexto()
        Catch ex As Exception
        End Try
        ...
        Select Case NOMBRECOMPONENTE
            ...
            Case Cu_BuscarPersonaDirectorObra.Name
                Me.Cu_BuscarPersonaDirectorObra.Cb_Persona.SelectedValue = IDPERSONA
            Case Cu_BuscarPersonaCoordinadorHSE.Name
                Me.Cu_BuscarPersonaCoordinadorHSE.Cb_Persona.SelectedValue = IDPERSONA
            Case Cu_BuscarPersonaResponsableActividad.Name
                Me.Cu_BuscarPersonaResponsableActividad.Cb_Persona.SelectedValue = IDPERSONA
            Case Cu_BuscarPersonaMedicoEnfermero.Name
                Me.Cu_BuscarPersonaMedicoEnfermero.Cb_Persona.SelectedValue = IDPERSONA
        End Select
    End Sub
    ...
    Public Sub EventoCajaEnter(Optional ByVal NombreComponente As String = "")
        ...
        Select Case NombreComponente
            Case Me.Cu_BuscarPersonaAfectada.Name
                ...
                End Try
            Case Me.Cu_BuscarPersonaResponsableActividad.Name
                Try
                    filas = Cu_BuscarPersonaResponsableActividad.DT_BUSCARPERSONA.Select("IDENTIFICACION='" + (Cu_BuscarPersonaResponsableActividad.Tx_TextoCódigo.Text).ToString + "'")
                    If filas.Length > 0 Then
                        Dim fila As DataRow = filas(0)
                        Me.Cu_BuscarPersonaResponsableActividad.Cb_Persona.SelectedValue = fila("IDPERSONA")
                    Else
                        MsgBox("Esta identificación no esta registrada o no esta asociada a la bodega", MsgBoxStyle.Critical, "No se encuentra")
                    End If
                Catch
                    Me.Cu_BuscarPersonaResponsableActividad.Tx_TextoCódigo.Text = ""
                End Try
            Case Me.Cu_BuscarPersonaMedicoEnfermero.Name
                Try
                    filas = Cu_BuscarPersonaMedicoEnfermero.DT_BUSCARPERSONA.Select("IDENTIFICACION='" + (Cu_BuscarPersonaMedicoEnfermero.Tx_TextoCódigo.Text).ToString + "'")
                    If filas.Length > 0 Then
                        Dim fila As DataRow = filas(0)
                        Me.Cu_BuscarPersonaMedicoEnfermero.Cb_Persona.SelectedValue = fila("IDPERSONA")
                    Else
                        MsgBox("Esta identificación no esta registrada o no esta asociada a la bodega", MsgBoxStyle.Critical, "No se encuentra")
                    End If
                Catch
                    Me.Cu_BuscarPersonaMedicoEnfermero.Tx_TextoCódigo.Text = ""
                End Try
            Case Me.Cu_BuscarPersonaDirectorObra.Name
                Try
                    filas = Cu_BuscarPersonaDirectorObra.DT_BUSCARPERSONA.Select("IDENTIFICACION='" + (Cu_BuscarPersonaDirectorObra.Tx_TextoCódigo.Text).ToString + "'")
                    If filas.Length > 0 Then
                        Dim fila As DataRow = filas(0)
                        Me.Cu_BuscarPersonaDirectorObra.Cb_Persona.SelectedValue = fila("IDPERSONA")
                    Else
                        MsgBox("Esta identificación no esta registrada o no esta asociada a la bodega", MsgBoxStyle.Critical, "No se encuentra")
                    End If
                Catch
                    Me.Cu_BuscarPersonaDirectorObra.Tx_TextoCódigo.Text = ""
                End Try
            Case Me.Cu_BuscarPersonaReporta.Name
                ...
                End Try
            Case Me.Cu_BuscarPersonaCoordinadorHSE.Name
                Try
                    filas = Cu_BuscarPersonaCoordinadorHSE.DT_BUSCARPERSONA.Select("IDENTIFICACION='" + (Cu_BuscarPersonaCoordinadorHSE.Tx_TextoCódigo.Text).ToString + "'")
                    If filas.Length > 0 Then
                        Dim fila As DataRow = filas(0)
                        Me.Cu_BuscarPersonaCoordinadorHSE.Cb_Persona.SelectedValue = fila("IDPERSONA")
                    Else
                        MsgBox("Esta identificación no esta registrada o no esta asociada a la bodega", MsgBoxStyle.Critical, "No se encuentra")
                    End If
                Catch
                    Me.Cu_BuscarPersonaCoordinadorHSE.Tx_TextoCódigo.Text = ""
                End Try
        End Select
    End Sub
    ...
    Private Sub Bt_AgregarTestigo_Click(sender As Object, e As EventArgs) Handles Bt_Agregar.Click
        If AgregarFilas_Testigos() = True Then
            Dim fila As DataRow
            fila = dtTestigos.NewRow
            dtTestigos.Rows.Add(fila)
        End If
