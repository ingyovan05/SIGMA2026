...
Public Class Fr_CrearInvestigacion
    ...
    Private Sub Fr_CrearInvestigacion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            If TIPOINCIDENTE = 2 Then
                ...
                Me.Tb_AfectacionDaño.Location = New Drawing.Point(106, 52)
                Me.Tb_SustanciaProceso.Location = New Drawing.Point(106, 19)
            Else
                'Tipo Ambiental
                If TIPOINCIDENTE = 3 Then
                    ...
                    Me.Tb_AfectacionDaño.Location = New Drawing.Point(73, 52)
                    Me.Tb_SustanciaProceso.Location = New Drawing.Point(193, 19)
                Else
                    'Tipo Casi-Accidente
    ...
    Public Sub ComportamientoPredeterminado()
        ...
        Me.Cb_CategoriaReal.SelectedIndex = -1
        ...
        Me.Dgv_AccionesATomar.Columns(2).ReadOnly = True
        'Agregar DateTimePickers a los DGV
        Dim ColumnFechaLimite = New Cl_ColumnaFecha
        Dgv_AccionesATomar.Columns.Insert(4, ColumnFechaLimite)
        Dgv_AccionesATomar.Columns(4).HeaderText = "Fecha Limite"
        Dgv_AccionesATomar.Columns(4).Name = "DGVDTP_FechaLimite"
        Dgv_AccionesATomar.Columns(4).DataPropertyName = "Fecha Limite"

        Dim ColumnFechaTerminado = New Cl_ColumnaFecha
        Dgv_AccionesATomar.Columns.Insert(5, ColumnFechaTerminado)
        Dgv_AccionesATomar.Columns(5).HeaderText = "Fecha Terminado"
        Dgv_AccionesATomar.Columns(5).Name = "DGVDTP_FechaTerminado"
        Dgv_AccionesATomar.Columns(5).DataPropertyName = "Fecha Terminado"
        ...
        If TIPOINCIDENTE = 1 Then
            ...
            Lb_Costo1.Text = "Lesion $"
            Tb_Costo1.Location = New Drawing.Point(125, 27)

            Lb_Especificar1.Location = New Drawing.Point(320, 30)
            Tb_Especificar1.Location = New Drawing.Point(390, 27)
            ...
            Lb_Especificar4.Location = New Drawing.Point(320, 62)
            Tb_Especificar4.Location = New Drawing.Point(390, 59)

            Lb_Costo4.Location = New Drawing.Point(11, 62)
            Tb_Costo4.Location = New Drawing.Point(125, 59)

            Lb_Especificar5.Location = New Drawing.Point(320, 96)
            Tb_Especificar5.Location = New Drawing.Point(390, 93)

            Lb_Costo5.Location = New Drawing.Point(11, 96)
            Tb_Costo5.Location = New Drawing.Point(125, 93)

            Lb_Especificar6.Location = New Drawing.Point(320, 129)
            Tb_Especificar6.Location = New Drawing.Point(390, 126)

            Lb_Costo6.Location = New Drawing.Point(11, 129)
            Tb_Costo6.Location = New Drawing.Point(125, 126)

            Lb_Costo7.Location = New Drawing.Point(11, 163)
            Tb_Costo7.Location = New Drawing.Point(125, 160)

            Gb_Pregunta1.Text = "¿Se han identificado los peligros?"
        ...
        Else
            If TIPOINCIDENTE = 2 Then
                ...
                Lb_Costo3.Location = New Drawing.Point(11, 62)
                Tb_Costo3.Location = New Drawing.Point(125, 59)

                Lb_Especificar3.Location = New Drawing.Point(320, 62)
                Tb_Especificar3.Location = New Drawing.Point(390, 59)

                Lb_Costo4.Location = New Drawing.Point(11, 96)
                Tb_Costo4.Location = New Drawing.Point(125, 93)

                Lb_Especificar4.Location = New Drawing.Point(320, 96)
                Tb_Especificar4.Location = New Drawing.Point(390, 93)

                Lb_Costo5.Location = New Drawing.Point(11, 129)
                Tb_Costo5.Location = New Drawing.Point(125, 126)

                Lb_Especificar5.Location = New Drawing.Point(320, 129)
                Tb_Especificar5.Location = New Drawing.Point(390, 126)

                Lb_Especificar6.Location = New Drawing.Point(320, 163)
                Tb_Especificar6.Location = New Drawing.Point(390, 160)

                Lb_Costo6.Location = New Drawing.Point(11, 163)
                Tb_Costo6.Location = New Drawing.Point(125, 160)

                Lb_Costo7.Location = New Drawing.Point(11, 194)
                Tb_Costo7.Location = New Drawing.Point(125, 191)
            ...
            Else
                If TIPOINCIDENTE = 3 Then
                    ...
                    Tb_Costo2.Location = New Drawing.Point(125, 59)

                    Tb_Costo3.Location = New Drawing.Point(125, 93)

                    Tb_Costo4.Location = New Drawing.Point(125, 126)

                    Tb_Costo5.Location = New Drawing.Point(125, 160)

                    Tb_Costo6.Location = New Drawing.Point(125, 191)

                    Tb_Costo7.Location = New Drawing.Point(125, 220)

                    Gb_Pregunta1.Text = "¿Se han identificado los Aspectos?"
    ...
    Public Sub CargarTablas()
        ...
        Cb_CategoriaReal.DataSource = dsCargar.Tables(7).Copy
        Cb_CategoriaReal.ValueMember = "ID"
        Cb_CategoriaReal.DisplayMember = "NOMBRE"
    ...
    Public Sub LlenarReporte()
        ...
        If TIPO = 2 Then
            ...
            If filareporte("IDTIPOINCIDENTE").ToString = "1" Then
                ...
                If Not IsDBNull(filareporteinv("REGISTRO")) Then
                    Me.Tb_RegistroMedico.Text = filareporteinv("REGISTRO")
                End If
                If Not IsDBNull(filareporteinv("NOMBREHOSPITAL")) Then
                    Me.Tb_NombreHospital.Text = filareporteinv("NOMBREHOSPITAL")
                End If
            ...
            If Not IsDBNull(filareporteinv("CATEGORIAPERDIDAREAL")) Then
                ...
                End If
            End If
            If Not IsDBNull(filareporteinv("CATEGORIAPERDIDAREAL2")) Then
                Me.Cb_CategoriaReal.SelectedValue = filareporteinv("CATEGORIAPERDIDAREAL2")
            End If
            If Not IsDBNull(filareporteinv("RESPUESTA10_1")) Then
            ...
            End If
            If Not IsDBNull(filareporteinv("RESPUESTA10_2")) Then
            ...
            End If
            If Not IsDBNull(filareporteinv("RESPUESTA10_3")) Then
                Me.Rb_Pregunta3No.Checked = False
                Me.Rb_Pregunta3Si.Checked = True
                Me.Tb_Pregunta3.Text = filareporteinv("RESPUESTA10_3")
            Else
                Me.Rb_Pregunta3No.Checked = True
                Me.Rb_Pregunta3Si.Checked = False
            End If
    ...
    Private Sub Dgv_AccionesATomar_CellEndEdit(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Dgv_AccionesATomar.CellEndEdit
        Select Case e.ColumnIndex
            Case Dgv_AccionesATomar.Columns("DGVT_CedulaAccionesATomar").Index
                If IsDBNull(Dgv_AccionesATomar.Item(e.ColumnIndex, e.RowIndex).Value) Or Dgv_AccionesATomar.Item(e.ColumnIndex, e.RowIndex).Value Is Nothing Then
                    MsgBox("Debe ingresar un valor")
                    Exit Sub
                End If
                For i = 0 To Dgv_AccionesATomar.Rows.Count - 2
                    If Dgv_AccionesATomar.Item(e.ColumnIndex, i).Value.ToString = "" Then
                        MsgBox("Hay campos de la columna cedula sin llenar anteriores a la fila actual")
                        Dgv_AccionesATomar.Item(e.ColumnIndex, i).Value = ""
                        dtAccionesATomar.Rows().RemoveAt(i)
                        Exit Sub
                    End If
                Next
                For i = 0 To Dgv_AccionesATomar.Rows.Count - 2
                    If e.RowIndex <> i Then
                        If Not IsDBNull(Dgv_AccionesATomar.Item(e.ColumnIndex, e.RowIndex).Value) Or Trim(Dgv_AccionesATomar.Item(e.ColumnIndex, e.RowIndex).Value.ToString) = "" Or Dgv_AccionesATomar.Item(e.ColumnIndex, e.RowIndex).Value Is Nothing Then
                            If Dgv_AccionesATomar.Item(e.ColumnIndex, e.RowIndex).Value = Dgv_AccionesATomar.Rows(i).Cells("DGVT_CedulaAccionesATomar").Value Then
                                Dgv_AccionesATomar.Item(e.ColumnIndex, e.RowIndex).Value = ""
                                MsgBox("Ya hay un testigo con ese número de documento")
                                Exit Sub
                            End If
                        End If
                    ...
                    End If
                Next
                Dim Cadena_Consulta As String = "select P.IDPERSONA from PERSONA as P where P.IDENTIFICACION = '" + Dgv_AccionesATomar.Item(e.ColumnIndex, e.RowIndex).Value + "'"
                Dim IdPersona As String
                Dim Consulta As New SqlCommand(Cadena_Consulta)
                Dim Conexión As New SqlConnection(VariablesBase.VariablesBase.Conexion_Remota_Sql_Server.ConnectionString)
                Consulta.Connection = Conexión
                ...
                adaptador.Fill(dt)
                Consulta2.Connection.Close()
                Dgv_AccionesATomar.Rows(e.RowIndex).Cells("DGVT_NombreAccionesATomar").Value = dt(0).Item(0)
        End Select
    End Sub
    ...
    Public Sub GuardarReporteInvestigacion()
        ...
        If TIPOINCIDENTE = 1 Then
            ...
            If Me.Tb_RegistroMedico.Text <> "" Then
                Comando.Parameters.AddWithValue("@REGISTRO", Me.Tb_RegistroMedico.Text)
            End If
            ...
            End If
            Comando.Parameters.AddWithValue("@NOMBREHOSPITAL", Me.Tb_NombreHospital.Text)
        ...
        Else
            ...
            End If
        End If
        categoria = letratipo + Me.Cb_Recurrencia.SelectedValue.ToString
        ...
        Dim letratiporeal As String
        If Me.Cb_SeveridadReal.SelectedValue = 1 Or Me.Cb_SeveridadReal.SelectedValue = 6 Or Me.Cb_SeveridadReal.SelectedValue = 11 Then
            letratiporeal = "A"
        Else
            If Me.Cb_SeveridadReal.SelectedValue = 2 Or Me.Cb_SeveridadReal.SelectedValue = 7 Or Me.Cb_SeveridadReal.SelectedValue = 12 Then
                letratiporeal = "B"
            Else
                If Me.Cb_SeveridadReal.SelectedValue = 3 Or Me.Cb_SeveridadReal.SelectedValue = 8 Or Me.Cb_SeveridadReal.SelectedValue = 13 Then
                    letratiporeal = "C"
                Else
                    If Me.Cb_SeveridadReal.SelectedValue = 4 Or Me.Cb_SeveridadReal.SelectedValue = 9 Or Me.Cb_SeveridadReal.SelectedValue = 14 Then
                        letratiporeal = "D"
                    Else
                        letratiporeal = "E"
                    End If
        ...
        If Me.Cb_RecurrenciaReal.SelectedValue IsNot Nothing Then
            categoriareal = letratiporeal + Me.Cb_RecurrenciaReal.SelectedValue.ToString
            Comando.Parameters.AddWithValue("@CATEGORIAPERDIDAREAL", categoriareal)
        Else
            categoriareal = ""
        End If
        If categoriareal <> "" Then
            If categoriareal = "A1" Or categoriareal = "A2" Or categoriareal = "A3" Or categoriareal = "B2" Or categoriareal = "B3" Then
                Comando.Parameters.AddWithValue("@NIVELPERDIDAREAL", "A")
            End If
            If categoriareal = "B1" Or categoriareal = "C1" Or categoriareal = "C2" Or categoriareal = "C3" Or categoriareal = "D2" Or categoriareal = "D3" Then
                Comando.Parameters.AddWithValue("@NIVELPERDIDAREAL", "M")
            End If
            If categoriareal = "D1" Or categoriareal = "E1" Or categoriareal = "E2" Or categoriareal = "E3" Then
                Comando.Parameters.AddWithValue("@NIVELPERDIDAREAL", "B")
            End If
        End If

        If Me.Cb_CategoriaReal.SelectedIndex <> -1 Then
            Comando.Parameters.AddWithValue("@CATEGORIAPERDIDAREAL2", Me.Cb_CategoriaReal.SelectedValue)
        End If
        ...
        End If
        If Rb_Pregunta3Si.Checked Then
            Comando.Parameters.AddWithValue("@RESPUESTA10_3", Me.Tb_Pregunta3.Text)
        End If
        ...
        If dtAccionesATomar.Rows.Count > 0 Then
            QuitarFilasVaciasAccionesATomar()
            ...
            TablaAccionesATomar.Columns.Add("IDPERSONA")
            ...
            For i = 0 To dtAccionesATomar.Rows.Count - 1
                Dim IdPersona
                Dim Cadena_Consulta3 As String = "SELECT IDPERSONA FROM PERSONA WHERE IDENTIFICACION  = '" + Dgv_AccionesATomar.Rows(i).Cells("DGVT_CedulaAccionesATomar").Value + "'"
                Dim Consulta3 As New SqlClient.SqlCommand(Cadena_Consulta3)
                Dim Conexión As New SqlConnection(VariablesBase.VariablesBase.Conexion_Remota_Sql_Server.ConnectionString)
                Consulta3.Connection = Conexión
                Consulta3.Connection.Open()
                ...
                FilaAcciones("ACCION") = dtAccionesATomar.Rows(i).Item(2).ToString
                FilaAcciones("IDPERSONA") = IdPersona
                FilaAcciones("PRIORIDAD") = dtAccionesATomar.Rows(i).Item(3).ToString
                Dim Fechalimite As DateTime
                Fechalimite = Convert.ToDateTime(dtAccionesATomar.Rows(i).Item(4))
                FilaAcciones("FECHALIMITE") = Fechalimite
                Dim Fechaterminado As DateTime
                Fechaterminado = Convert.ToDateTime(dtAccionesATomar.Rows(i).Item(5))
        ...
        If dtCausasInmediatasCondiciones.Rows.Count > 0 Then
            QuitarFilasVaciasCausasCondiciones()
        ...
        If dtCausasBasicasPersonales.Rows.Count > 0 Then
            QuitarFilasVaciasCausasPersonales()
        ...
        If dtCausasBasicasTrabajo.Rows.Count > 0 Then
            QuitarFilasVaciasCausasTrabajo()
        ...
        If dtInvestigadores.Rows.Count > 0 Then
            QuitarFilasVaciasInvestigadores()
        ...
        If dtLineaTiempo.Rows.Count > 0 Then
            ...
            For i = 0 To dtLineaTiempo.Rows.Count - 1
                ...
                FilaLineaTiempo("FECHA") = Dgv_LineaTiempo.Rows(i).Cells("DGVDTP_FechaLineaTiempo").Value
                FilaLineaTiempo("HORA") = Dgv_LineaTiempo.Rows(i).Cells("DGVDTP_HoraLineaTiempo").FormattedValue.ToString
                FilaLineaTiempo("DESCRIPCION") = Dgv_LineaTiempo.Rows(i).Cells("DGVT_Descripcion").Value
    ...
    Private Sub Bt_Guardar_Click(sender As Object, e As EventArgs) Handles Bt_Guardar.Click
        GuardarReporteInvestigacion()
        Me.Close()
    End Sub

    Private Sub Rb_Pregunta1No_CheckedChanged(sender As Object, e As EventArgs) Handles Rb_Pregunta1No.CheckedChanged
        Lb_Pregunta1.Hide()
        Tb_Pregunta1.Hide()
    End Sub

    Private Sub Rb_Pregunta1Si_CheckedChanged(sender As Object, e As EventArgs) Handles Rb_Pregunta1Si.CheckedChanged
        Lb_Pregunta1.Show()
        Tb_Pregunta1.Show()
    End Sub
    ...
    Private Sub Rb_Pregunta3No_CheckedChanged(sender As Object, e As EventArgs) Handles Rb_Pregunta3No.CheckedChanged
        Lb_Pregunta3.Hide()
        Tb_Pregunta3.Hide()
    End Sub

    Private Sub Rb_Pregunta3Si_CheckedChanged(sender As Object, e As EventArgs) Handles Rb_Pregunta3Si.CheckedChanged
        Lb_Pregunta3.Show()
        Tb_Pregunta3.Show()
    End Sub
    ...
    Private Function AgregarFilas_LineaTiempo() Handles Dgv_LineaTiempo.RowLeave
        If Dgv_LineaTiempo.Rows.Count >= 9 Then
        ...
        End If
    End Function
    Private Sub QuitarFilas_LineaTiempo(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewRowsRemovedEventArgs) Handles Dgv_LineaTiempo.RowsRemoved
        If Dgv_LineaTiempo.Rows.Count < 10 Then
            Dgv_LineaTiempo.AllowUserToAddRows = True
        End If
    End Sub
    ...
    Private Sub Bt_AgregarLineaTiempo_Click(sender As Object, e As EventArgs) Handles Bt_AgregarLineaTiempo.Click
        ...
        End If
    End Sub
    Private Function AgregarFilas_Acciones() Handles Dgv_AccionesATomar.RowLeave
        ...
        End If
    End Function
    Private Sub QuitarFilas_Acciones(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewRowsRemovedEventArgs) Handles Dgv_AccionesATomar.RowsRemoved
        If Dgv_AccionesATomar.Rows.Count < 8 Then
            Dgv_AccionesATomar.AllowUserToAddRows = True
        End If
    End Sub
    ...
    Private Sub Bt_AgregarTestigo_Click(sender As Object, e As EventArgs) Handles Bt_AgregarTestigo.Click
        ...
        End If
    End Sub
    Private Function AgregarFilas_Investigadores() Handles Dgv_Investigadores.RowLeave
        ...
        End If
    End Function
    Private Sub QuitarFilas_Investigadores(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewRowsRemovedEventArgs) Handles Dgv_Investigadores.RowsRemoved
        If Dgv_Investigadores.Rows.Count < 8 Then
            Dgv_Investigadores.AllowUserToAddRows = True
        End If
    End Sub
    Private Sub Bt_AgregarInvestigacion_Click(sender As Object, e As EventArgs) Handles Bt_AgregarInvestigacion.Click
        ...
        End If
    End Sub
    Private Function AgregarFilas_CausasActos() Handles Dgv_CausasInmediatasActos.RowLeave
        If Dgv_CausasInmediatasActos.Rows.Count >= 2 Then
        ...
        End If
    End Function
    Private Sub QuitarFilas_CausasActos(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewRowsRemovedEventArgs) Handles Dgv_CausasInmediatasActos.RowsRemoved
        If Dgv_CausasInmediatasActos.Rows.Count < 3 Then
            Dgv_CausasInmediatasActos.AllowUserToAddRows = True
        End If
    End Sub
    Private Sub Bt_AgregarCausaInmediataActos_Click(sender As Object, e As EventArgs) Handles Bt_AgregarCausaInmediataActos.Click
        ...
        End If
    End Sub
    Private Function AgregarFilas_CausasCondiciones() Handles Dgv_CausasInmediatasCondiciones.RowLeave
        If Dgv_CausasInmediatasCondiciones.Rows.Count >= 2 Then
        ...
        End If
    End Function
    Private Sub QuitarFilas_CausasCondiciones(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewRowsRemovedEventArgs) Handles Dgv_CausasInmediatasCondiciones.RowsRemoved
        If Dgv_CausasInmediatasCondiciones.Rows.Count < 3 Then
            Dgv_CausasInmediatasCondiciones.AllowUserToAddRows = True
        End If
    End Sub
    Private Sub Bt_AgregarCausaInmediataCondiciones_Click(sender As Object, e As EventArgs) Handles Bt_AgregarCausaInmediataCondiciones.Click
        ...
        End If
    End Sub
    Private Function AgregarFilas_CausasPersonales() Handles Dgv_CausasBasicasPersonales.RowLeave
        If Dgv_CausasBasicasPersonales.Rows.Count >= 2 Then
        ...
        End If
    End Function
    Private Function QuitarFilas_CausasPersonales() Handles Dgv_CausasBasicasPersonales.RowsRemoved
        If Dgv_CausasBasicasPersonales.Rows.Count < 3 Then
            Dgv_CausasBasicasPersonales.AllowUserToAddRows = True
            Return True
        Else
            Return False
        End If
    ...
    Private Sub Bt_AgregarCausaBasicaPersonal_Click(sender As Object, e As EventArgs) Handles Bt_AgregarCausaBasicaPersonal.Click
        ...
        End If
    End Sub
    Private Function AgregarFilas_CausasTrabajo() Handles Dgv_CausasBasicasTrabajo.RowLeave
        If Dgv_CausasBasicasTrabajo.Rows.Count >= 2 Then
        ...
        End If
    End Function
    Private Sub QuitarFilas_CausasTrabajo(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewRowsRemovedEventArgs) Handles Dgv_CausasBasicasTrabajo.RowsRemoved
        If Dgv_CausasBasicasTrabajo.Rows.Count < 3 Then
            Dgv_CausasBasicasTrabajo.AllowUserToAddRows = True
        End If
    End Sub
    Private Sub Bt_AgregarCausaBasicaTrabajo_Click(sender As Object, e As EventArgs) Handles Bt_AgregarCausaBasicaTrabajo.Click
        ...
        End If
    End Sub
    Private Function AgregarFilas_Evidencias() Handles Dgv_Evidencias.RowLeave
        If Dgv_Evidencias.Rows.Count >= 19 Then
        ...
        End If
    End Function
    Private Sub QuitarFilas_Evidencias(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewRowsRemovedEventArgs) Handles Dgv_Evidencias.RowsRemoved
        If Dgv_Evidencias.Rows.Count < 20 Then
            Dgv_Evidencias.AllowUserToAddRows = True
        End If
    End Sub
    ...
    'Muestra la imagen de la matriz de perdida
    ...
    'Private Sub Bt_VerMatrizReal_Click(sender As Object, e As EventArgs) Handles Bt_VerMatrizReal.Click
    '    Dim Matriz As New Fr_MatrizPerdida
    '    Matriz.ShowDialog()
    'End Sub
    ...
    Private Sub CalcularPerdidaReal()
        ...
        If categoria = "D1" Or categoria = "E1" Or categoria = "E2" Or categoria = "E3" Then
            nivel = "Bajo"
        End If
        Tb_CategoriaResultanteReal.Text = categoria + ", Potencial:" + nivel
    End Sub
    ...
    Private Sub QuitarFilasVaciasLT()
        Dim cantidad As Integer = Me.dtLineaTiempo.Rows.Count
        Dim flag As Boolean = False
        For i As Integer = cantidad - 1 To 0 Step -1
            Dim row As DataGridViewRow = Dgv_LineaTiempo.Rows(i)
            For j As Integer = 0 To Dgv_LineaTiempo.Columns.Count - 1
            ...
            Next
            If flag = True Then
                dtLineaTiempo.Rows.RemoveAt(i)
                flag = False
            End If
        Next
    End Sub
    Private Sub QuitarFilasVaciasTestigos()
        Dim cantidad As Integer = Me.dtTestigos.Rows.Count
        Dim flag As Boolean = False
        For i As Integer = cantidad - 1 To 0 Step -1
            Dim row As DataGridViewRow = Dgv_Testigos.Rows(i)
            For j As Integer = 0 To Dgv_Testigos.Columns.Count - 1
                If Not row.IsNewRow And IsDBNull(row.Cells(j).Value) Or row.Cells(j).Value Is Nothing Then
                    flag = True
                Else
                    flag = False
        ...
        Next
    End Sub
    Private Sub QuitarFilasVaciasAccionesATomar()
        Dim cantidad As Integer = Me.dtAccionesATomar.Rows.Count
        Dim flag As Boolean = False
        For i As Integer = cantidad - 1 To 0 Step -1
            Dim row As DataGridViewRow = Dgv_AccionesATomar.Rows(i)
            For j As Integer = 0 To Dgv_AccionesATomar.Columns.Count - 1
                If Not row.IsNewRow And IsDBNull(row.Cells(j).Value) Or row.Cells(j).Value Is Nothing Then
                    flag = True
                Else
                    flag = False
        ...
        Next
    End Sub
    Private Sub QuitarFilasVaciasEvidencias()
        Dim cantidad As Integer = Me.dtEvidencias.Rows.Count
        Dim flag As Boolean = False
        For i As Integer = cantidad - 1 To 0 Step -1
            Dim row As DataGridViewRow = Dgv_Evidencias.Rows(i)
            For j As Integer = 0 To Dgv_Evidencias.Columns.Count - 1
                If Not row.IsNewRow And IsDBNull(row.Cells(j).Value) Or row.Cells(j).Value Is Nothing Then
                    flag = True
                Else
                    flag = False
            ...
            Next
            If flag = True Then
                dtEvidencias.Rows.RemoveAt(i)
                flag = False
            End If
        Next
    End Sub
    Private Sub QuitarFilasVaciasCausasActos()
        Dim cantidad As Integer = Me.dtCausasInmediatasActos.Rows.Count
        Dim flag As Boolean = False
        For i As Integer = cantidad - 1 To 0 Step -1
            Dim row As DataGridViewRow = Dgv_CausasInmediatasActos.Rows(i)
            For j As Integer = 0 To Dgv_CausasInmediatasActos.Columns.Count - 1
                If Not row.IsNewRow And IsDBNull(row.Cells(j).Value) Or row.Cells(j).Value Is Nothing Then
                    flag = True
                Else
                    flag = False
            ...
            Next
            If flag = True Then
                dtCausasInmediatasActos.Rows.RemoveAt(i)
                flag = False
            End If
        Next
    End Sub
    Private Sub QuitarFilasVaciasCausasCondiciones()
        Dim cantidad As Integer = Me.dtCausasInmediatasCondiciones.Rows.Count
        Dim flag As Boolean = False
        For i As Integer = cantidad - 1 To 0 Step -1
            Dim row As DataGridViewRow = Dgv_CausasInmediatasActos.Rows(i)
            ...
            Next
            If flag = True Then
                dtCausasInmediatasCondiciones.Rows.RemoveAt(i)
                flag = False
            End If
        Next
    End Sub
    Private Sub QuitarFilasVaciasCausasPersonales()
        Dim cantidad As Integer = Me.dtCausasBasicasPersonales.Rows.Count
        Dim flag As Boolean = False
        For i As Integer = cantidad - 1 To 0 Step -1
            Dim row As DataGridViewRow = Dgv_CausasBasicasPersonales.Rows(i)
            For j As Integer = 0 To Dgv_CausasBasicasPersonales.Columns.Count - 1
                If Not row.IsNewRow And IsDBNull(row.Cells(j).Value) Or row.Cells(j).Value Is Nothing Then
                    flag = True
                Else
                    flag = False
            ...
            Next
            If flag = True Then
                dtCausasBasicasPersonales.Rows.RemoveAt(i)
                flag = False
            End If
        Next
    End Sub
    Private Sub QuitarFilasVaciasCausasTrabajo()
        Dim cantidad As Integer = Me.dtCausasBasicasTrabajo.Rows.Count
        Dim flag As Boolean = False
        For i As Integer = cantidad - 1 To 0 Step -1
            Dim row As DataGridViewRow = Dgv_CausasBasicasTrabajo.Rows(i)
            For j As Integer = 0 To Dgv_CausasBasicasTrabajo.Columns.Count - 1
                If Not row.IsNewRow And IsDBNull(row.Cells(j).Value) Or row.Cells(j).Value Is Nothing Then
                    flag = True
                Else
                    flag = False
            ...
            Next
            If flag = True Then
                dtCausasBasicasTrabajo.Rows.RemoveAt(i)
                flag = False
            End If
        Next
    End Sub
    Private Sub QuitarFilasVaciasInvestigadores()
        Dim cantidad As Integer = Me.dtInvestigadores.Rows.Count
        Dim flag As Boolean = False
        For i As Integer = cantidad - 1 To 0 Step -1
            Dim row As DataGridViewRow = Dgv_Investigadores.Rows(i)
            For j As Integer = 0 To Dgv_Investigadores.Columns.Count - 1
                If Not row.IsNewRow And IsDBNull(row.Cells(j).Value) Or row.Cells(j).Value Is Nothing Then
                    flag = True
                Else
                    flag = False
